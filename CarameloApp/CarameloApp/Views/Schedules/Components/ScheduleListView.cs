...
namespace CarameloApp.Views.Schedules.Components
{
	/// <summary>
	/// ListView personalizada para Agendamentos
	/// </summary>
	public class ScheduleListView : CustomListView<Schedule>
	{
		private readonly Action<object, CheckedChangedEventArgs> _checkBoxEvent;
